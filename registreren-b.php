...
<body>
    <div class="container">
        <div class="page-header text-center unselectable">
            <h1 class="unselectable mt-2 display-4">Registreren als bedrijf</h1>
            <hr>
        </div>
    </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($resultaat) {
            ...
            try {
                ...
                echo "<script>alert('Bedankt dat u uw bedrijf heeft geregistreerd bij PowerJobs. Succes met het vinden van werknemers.'); location.href='inloggen-b.php'</script>";
            } catch (PDOException $e) {
                echo "<script> alert('Er ging iets fout bij het aanmaken van uw account, probeer het opnieuw of neem contact op met een admin.');</script>";
                $e->getMessage();
            }
        }
    }
