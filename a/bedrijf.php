...
if (isset($_GET["id"])) {
    ...
    if ($r["aantal"]) {
        ...
        <div class="container mt-1 unselectable">
            <div class="row">
                ...
                <div class="col-9 text-right">
                    <div class="mt-3">
                        <a style="text-decoration: none; cursor: context-menu" class="text-secondary"><i class="fas fa-hashtag"></i><span class="ml-2">Bedrijfnummer:
        ...
        <div class="container text-center">
            ...
            <span class='d-md-inline-block d-block mr-md-3'><i class="fas fa-phone-alt"></i> <b><a style="color: black" href="tel: <?php echo $r["telefoon"] ?>"><?php echo $r["telefoon"] ?></a></b></span>
            <span class='d-md-inline-block d-block mr-md-3'><i class="fas fa-envelope"></i> <b><a style="color: black" href="mailto: <?php echo $r["email"] ?>"><?php echo $r["email"] ?></a></b></span>
            <hr>
            <h4>Hoofdlocatie</h4>
            <div style="width: 100%">
