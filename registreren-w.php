...
<body>
    <div class="container">
        <div class="page-header text-center unselectable">
            <h1 class="unselectable mt-2 display-4">Registreren als werknemer</h1>
            <hr>
        </div>
    </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        if ($resultaat) {
            ...
            try {
                ...
                echo "<script>alert('Welkom bij PowerJobs, $naam. Succes met het vinden van een leuke baan.'); location.href='inloggen.php-w'</script>";
