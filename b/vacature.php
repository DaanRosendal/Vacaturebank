...
if (!isset($_GET["id"])) {
    ...
    if ($r) {
        ...
        <p class="lead alert alert-info text-center"><b>Dit is hoe werknemers vacatures zien.</b></p>
        <div class="container mt-3 unselectable">
            <div class="row bg-white rounded">
                ...
                <div class="col-6 text-right">
                    <div class="mt-2 mb-2">
                        <button type="button" class="btn btn-success disabled">Solliciteren</button>
                    </div>
                </div>
            </div>
        </div>
